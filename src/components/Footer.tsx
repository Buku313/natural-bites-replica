    ...
    <footer className="bg-[#1a1a1a] text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Natural Bites. Todos los derechos reservados.</p>
          <p className="mt-2">
            Otra empresa de{' '}
            <a href="http://www.nacascolo.com" target="_blank" rel="noopener noreferrer" className="text-[#f5c964] hover:underline">
              www.nacascolo.com
            </a>
          </p>
        </div>
